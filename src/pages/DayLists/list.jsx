...
class ListingDayLists extends React.Component
{
    constructor(props)
    {
        super(props)
        ...
        axios.post(apiURL.DayLists.list,{}).then(result => {
            if(result.data)
            {
        ...
        return (
            <Grid container spacing={3} direction="column">
                <Grid item spacing={3} direction="row">
                        <Grid>
                            <Button color="primary" variant="contained" href={appURL.DayLists.create}>Create New</Button>
                        </Grid> 
                        <Grid> 
                        ...
                        <TableBody>
                            {
                                data.map((entry)=>{
                                    ...
                                    return (
                                        <TableRow>
                                            <TableCell>{entry.DayName}</TableCell>
                                            <TableCell>{(entry.Depreciated?"❌":"✅")}</TableCell>
                                            <TableCell>
                                                <Button href={appURL.DayLists.list+"/"+entry.id+"/edit"} variant="contained" color="primary">Edit</Button>
                                            </TableCell>
                                        </TableRow>
                                    );
                                })
...
export default ListingDayLists;