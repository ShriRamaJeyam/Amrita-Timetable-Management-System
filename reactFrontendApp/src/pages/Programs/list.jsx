...
class ListingPrograms extends React.Component
{
    constructor(props)
    {
        super(props)
        ...
        return (
            <Grid container spacing={3} direction="column">
                <Grid item spacing={3} direction="row">
                        <Grid>
                            <Button color="primary" variant="contained" href={appURL.Programs.create}>Create New</Button>
                        </Grid> 
                        <Grid> 
                                ...
                                data.map((entry)=>{
                                    ...
                                    return (
                                        <TableRow>
                                            ...
                                            <TableCell>
                                                <Button href={appURL.Programs.list+"/"+entry.id+"/edit"} variant="contained" color="primary">Edit</Button>
                                            </TableCell>
                                        </TableRow>
                                    );
                                })
...
export default ListingPrograms;